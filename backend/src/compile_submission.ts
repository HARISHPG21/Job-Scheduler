...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ER Diagram - constrained to exactly one printed page */
    .er-diagram-wrapper {
      width: 100%;
      padding: 0.25rem 0;
      display: block;
  ...
  <div>
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.5rem;">
      <div>
        ...
        <img src="./docs/screenshots/dashboard.png" alt="Overview Dashboard" style="max-height: 270px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">B. Jobs Explorer & Execution Logs (Complete task state list and stdout traces)</h3>
        <img src="./docs/screenshots/jobs.png" alt="Jobs Explorer" style="max-height: 270px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
