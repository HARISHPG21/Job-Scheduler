  ...
  <div>
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.5rem;">
      <div>
        ...
        <img src="./docs/screenshots/dashboard.png" alt="Overview Dashboard" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">B. Jobs Explorer & Execution Logs (Complete task state list and stdout traces)</h3>
        <img src="./docs/screenshots/jobs.png" alt="Jobs Explorer" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        ...
        <img src="./docs/screenshots/queues.png" alt="Queue Management" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">D. Worker Nodes Monitor (Track CPU/RAM utilization and active task allocations)</h3>
        <img src="./docs/screenshots/workers.png" alt="Worker Monitor" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">E. Cron Recurring Schedules (Automated background execution triggers)</h3>
        <img src="./docs/screenshots/cron.png" alt="Cron Schedules" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">F. Dead Letter Queue (DLQ) (Quarantine execution failures and retry tasks)</h3>
        <img src="./docs/screenshots/dlq.png" alt="Dead Letter Queue" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
      <div>
        <h3 style="margin-bottom: 0.1rem;">G. Portal Login Screen (Secure access authentication gate)</h3>
        <img src="./docs/screenshots/login.png" alt="Portal Login" style="max-height: 220px; width: 100%; object-fit: contain; border-radius: 12px; border: 1px solid var(--border); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
      </div>
    </div>
    </div>
  </div>
